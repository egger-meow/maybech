...
1. Present account-mode-correct available collateral and unrealized PnL. The
...
3. Provide one consistent searchable SWAP selector across Strategy creation,
...
4. Prevent Next.js 16.2.9 Turbopack from terminating the dashboard development
...
5. Remove the persisted-theme hydration mismatch. The Playwright interaction
...
6. Localize all operator-facing protection lifecycle controls consistently in
...
7. Make trade history distinguish separate logical executions. The Simulation
...
8. Make the documented local frontend URL work cleanly in development. A real
