...
| Canonical position-rule model | Partial | Strategy defaults and logical-position conditions persist schema-v1 purpose/style/trigger/action/parameters/evidence definitions through shared normalization and migrations. Typed OpenAPI responses expose the canonical definition. Initial stop promotion is built; take-profit materialization, automatic break-even, trailing state, and staged actions remain. |
